      ...
      <div className="legal-body">
        ...
        <section className="legal-section">
          ...
          <p>
            ...
            端末に依存しない記録の引き継ぎのために「復元コード」を発行します。
          </p>
          ...
          <h3>4. 復元コードの管理責任</h3>
          <p>
            記録の閲覧・復元に使用する「復元コード」は、お客様ご自身で管理していただくものとし、
            紛失・第三者への漏洩によって生じた損害について運営者は責任を負いません。
            復元コードを紛失した場合、該当の記録には二度とアクセスできなくなります。
          </p>
          ...
          <ul>
            ...
            <li>第三者になりすます行為、他者の復元コードを不正に取得・使用する行為</li>
          </ul>
        ...
        <section className="legal-section">
          ...
          <ul>
            ...
            <li>
              ...
              「復元コード」に紐づけて、ブランド名・アイテム区分・価格・メモ・任意で添付された写真をサーバー（Redis）に保存します。
          ...
          <h3>4. データの削除</h3>
          <p>
            仕入れ記録は履歴画面からいつでもご自身で削除できます。復元コードに紐づく全データの削除をご希望の場合は、下記お問い合わせ先までご連絡ください。
          </p>
