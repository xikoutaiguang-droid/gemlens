    ...
    <div className="legal-root">
      ...
      <div className="legal-body">
        ...
        <section className="legal-section">
          ...
          <h3>4. 外国にある第三者への提供について</h3>
          <p>
            上記の外部サービスの一部（Google社が提供するGemini API・Cloud Vision API・AdSense等）は、
            日本国外（主にアメリカ合衆国）のサーバーでデータを処理する場合があります。
            これらは国際的に広く利用されている大手事業者であり、各社が定める基準に基づいてデータを取り扱っています。
            各社のプライバシーポリシーは、それぞれの公式サイトでご確認いただけます。
          </p>

          <h3>5. 広告とCookieについて</h3>
          <p>
